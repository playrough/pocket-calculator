	...
	render() {
		return (
			<div className="calculator">
				...
				<div className="button btnAC btnDark" onClick={() => this.Clear()}>
					AC
				</div>
				<div className="button btnDEL btnDark" onClick={() => this.Delete()}>
					DEL
				</div>
				<div className="button btnDivi btnDark" onClick={() => this.AppendValue('/')}>
					<i className="bi bi-slash-lg"></i>
				</div>
				<div className="button btn7" onClick={() => this.AppendValue(7)}>
					7
				</div>
				<div className="button btn8" onClick={() => this.AppendValue(8)}>
					8
				</div>
				<div className="button btn9" onClick={() => this.AppendValue(9)}>
					9
				</div>
				<div className="button btnMult btnDark" onClick={() => this.AppendValue('*')}>
					<i className="bi bi-x-lg"></i>
				</div>
				<div className="button btn4" onClick={() => this.AppendValue(4)}>
					4
				</div>
				<div className="button btn5" onClick={() => this.AppendValue(5)}>
					5
				</div>
				<div className="button btn6" onClick={() => this.AppendValue(6)}>
					6
				</div>
				<div className="button btnSub btnDark" onClick={() => this.AppendValue('-')}>
					<i className="bi bi-dash-lg"></i>
				</div>
				<div className="button btn1" onClick={() => this.AppendValue(1)}>
					1
				</div>
				<div className="button btn2" onClick={() => this.AppendValue(2)}>
					2
				</div>
				<div className="button btn3" onClick={() => this.AppendValue(3)}>
					3
				</div>
				<div className="button btnAdd btnDark" onClick={() => this.AppendValue('+')}>
					<i className="bi bi-plus-lg"></i>
				</div>
				<div className="button btn0" onClick={() => this.AppendValue(0)}>
					0
				</div>
				<div className="button btnDot" onClick={() => this.AppendValue('.')}>
					.
				</div>
